...
> (莱布尼茨记法) 要用到微分，老师没说，因为 dy / dt = y'(t) 是微分形式。 y对t求导
>
> 为什么除以dt?，因为xy均能由中间变量t得到结果

- 什么叫x对t求导？就是把方程中的x替换为t，然后x'等于原式求导。

- 二阶导怎么求？在算出一阶导后，分别再除以 dt，也就是将算出来的结果，对t进行求导。所以，二阶导的分子就是一阶导的`dy / dx`对t求导，分母就是`x` （`dx`）对t求导

## [题一](https://www.bilibili.com/video/BV1husGzwEtZ?t=419.3&p=40)





## [二阶导](https://www.bilibili.com/video/BV1husGzwEtZ?t=990.2&p=40)



## [二阶导-题一](https://www.bilibili.com/video/BV1husGzwEtZ?t=1193.3&p=40)



## [一阶导-题二-隐](https://www.bilibili.com/video/BV1husGzwEtZ?t=1609.5&p=40)

1. 正常对x,y求导
2. 由于最后分子具有y，因此需要将给定值带入y中求出具体值

$$
\begin{aligned}
& x=(t+1) e^{2t} \\
=> & \ [(t+1)' \sdot e^{2t}] + [(t + 1) \sdot (e^{2t})'] \\
=> & \ e^{2t} + (te^{2t} + e^{2t}) \sdot 2\\
=> & \ e^{2t} + 2te^{2t} + 2e{2t} \\
=> & \ (2t + 3)e^{2t}
\\
\\
...
=> & \ (e^{y} + ty - e)' = 0 \\
& \text{此时的y应该被看作是t的函数} \\
=> & \ e^{y} \sdot y' + (t' \sdot y) + (t \sdot y') - 0 = 0 \\
=> & \ e^{y} \sdot y' + y + t \sdot y' = 0 \\ 
=> & \ y'(e^{y} + t) = -y \\
=> & \ y' = -\frac{y}{e^{y} + t}
\end{aligned}
$$
...
## [一阶导-题三-切线](https://www.bilibili.com/video/BV1husGzwEtZ?t=2394.1&p=40)

> 切线斜率就是一阶导
>
> k切 * k法要等于-1

## [二阶导的误区](https://www.bilibili.com/video/BV1husGzwEtZ?t=3012.3&p=40)



# [P41幂指函数求导](https://www.bilibili.com/video/BV1husGzwEtZ?p=41)

## [求导方法一](https://www.bilibili.com/video/BV1husGzwEtZ?t=53.5&p=41)

$$
\text{将}f(x)^{g(x)} \text{转换为} e^{\ln{f(x)^{g(x)}}} \\
e^{g(x) \ln{f(x)}} \text{将其看作复合函数进行求导} \\
y=x^{x} \text{试试？}
$$



## [对数求导法](https://www.bilibili.com/video/BV1husGzwEtZ?t=552.3&p=41)

对两边同时取对数，然后对隐函数求导

## [题一](https://www.bilibili.com/video/BV1husGzwEtZ?t=947.6&p=41)

## [题二-第一种](https://www.bilibili.com/video/BV1husGzwEtZ?t=1296.4&p=41)

## [*题三-连乘式](https://www.bilibili.com/video/BV1husGzwEtZ?t=1685.9&p=41)

## [常规考法](https://www.bilibili.com/video/BV1husGzwEtZ?t=2123.2&p=41)



# [P42分段函数求导](https://www.bilibili.com/video/BV1husGzwEtZ?p=42&)

> 开头有将左右导的定义。但还是建议回去看看

1. 使用左右导数的定义，求分段点的导数。进而判断分段点导数是否存在。
2. 非分段点部分直接使用求导法则



## [题一](https://www.bilibili.com/video/BV1husGzwEtZ?t=241.8&p=42)

## [题二](https://www.bilibili.com/video/BV1husGzwEtZ?t=829.4&p=42)

有间断点的小知识点



# [P43洛必达习题课](https://www.bilibili.com/video/BV1husGzwEtZ?t=53.9&p=43)



# [#导数的应用](https://www.bilibili.com/video/BV1husGzwEtZ?p=44)

> 考大题！！！

利用导数去研究函数的单调性，极值，凹凸性，拐点。

![image-20260628140631320](./2章专升本数学-一元函数微分学/image-20260628140631320.png)

# [P44一阶导和单调性的关系](https://www.bilibili.com/video/BV1husGzwEtZ?t=225.7&p=44)

## [斜率和一阶导的关系](https://www.bilibili.com/video/BV1husGzwEtZ?t=225.7&p=44)

## [单调性的判定定理](https://www.bilibili.com/video/BV1husGzwEtZ?t=470.9&p=44)

## [小题目](https://www.bilibili.com/video/BV1husGzwEtZ?t=1017.2&p=44)



# [*P45单调区间的求解](https://www.bilibili.com/video/BV1husGzwEtZ?p=45&)

一阶导数等于0（驻点），或者不可导点（一般都是分母为0），均称为可疑点

## [求解步骤](https://www.bilibili.com/video/BV1husGzwEtZ?t=227.7&p=45)

1. 求函数定义域
2. 求f'(x)，找到可疑点
3. 用可疑点将定义域分为多个区间，在各个区间上任意一个点带入f'(x)，根据值的正负来判断f(x)的单调性

## [题一](https://www.bilibili.com/video/BV1husGzwEtZ?t=381.4&p=45)

## [答案书写问题](https://www.bilibili.com/video/BV1husGzwEtZ?t=1400.4&p=45)

## [题二](https://www.bilibili.com/video/BV1husGzwEtZ?t=1732.6&p=45)



# [P46极值的定义](https://www.bilibili.com/video/BV1husGzwEtZ?p=46)
