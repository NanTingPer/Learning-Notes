...
namespace ThoriumModzhcn.Systems
{
    public static class LocalizeUtil
    {
        ...
        /// </summary>
        public static List<(string, string)> OneStepToGo(string fileName, string startChar = "") => Method(GetText(fileName), startChar);
        ...
        public static void LoadLocalizedKey(string fileName, Language language, string startChar = "")
        {
            ...
            foreach (var item in OneStepToGo(fileName, startChar)) {
                if (!keyValue.ContainsKey(item.Item1)) {
                    keyValue.Add(item.Item1, CreateLocalizedText(item.Item1, item.Item2));
                }
            }
        }
        ...
        /// </summary>
        private static List<(string, string)> Method(string translationFileContents, string startChar = "")
        {
