...
public class PoetryStyService : IPoetryStyService
{
    /// <summary>
    /// 判断版本号
    /// </summary>
    ...
    public PoetryStyService(IConfig config)
    {
    ...
    public async System.Threading.Tasks.Task InitializeAsync()
    {
        if (IsInitialized == false)
        {
            ...
            //资源文件流
            await using Stream DbStream = typeof(PoetryStyService).Assembly.GetManifestResourceStream(DbName);
