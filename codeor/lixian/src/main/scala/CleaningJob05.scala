...
object CleaningJob05{
  ...
  // case class
  private case class OrderDetail(
  ...
  def readHBase(spark:SparkSession):DataFrame = {
    ...
    hbaseConf.set("hbase.zookeeper.quorum", "192.168.45.13") //设置zooKeeper集群地址，也可以通过将hbase-site.xml拷贝到resources目录下
    hbaseConf.set("hbase.zookeeper.property.clientPort", "2181") //设置zookeeper连接端口，默认2181
    hbaseConf.set("hbase.master", "192.168.45.13:16000")     // 设置HBase HMaster
