...
//        ods_ds_hudi库中user_info
        ...
        val huditable = spark.read.format("hudi").load(s"hdfs:///user/hive/warehouse/ods_ds_hudi.db/${tablename}")
            .drop("_hoodie_commit_time","_hoodie_commit_seqno","_hoodie_record_key","_hoodie_partition_path","_hoodie_file_name")
            .where(col("etl_date") === lit("20250324"))
...
//            .union(odsdata)
        ...
        un_t
            ...
            .option(HoodieWriteConfig.TBL_NAME.key,"dim_user_info")
