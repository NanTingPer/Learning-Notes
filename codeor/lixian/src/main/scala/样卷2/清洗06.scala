...
object 清洗06 {
    def main(args: Array[String]): Unit = {
        val spark = SparkSession
            ...
            .getOrCreate()
//        ods_ds_hudi库中user_detail


        val huditable = spark.read.format("hudi").load("hdfs:///user/hive/warehouse/ods_ds_hudi.db/order_detail")
...
//        val odstable = spark.read.format("hudi").load("hdfs:///user/hive/warehouse/dwd_ds_hudi.db/dim_user_detail")
//            .drop("_hoodie_commit_time", "_hoodie_commit_seqno", "_hoodie_record_key", "_hoodie_partition_path", "_hoodie_file_name")
//
//        odstable.show()
//
...
//        val win2 = Window.partitionBy("id")
        ...
        val hudinewtabke = huditable
            ...
            .withColumn("etl_date",col("create_time"))
//            .select(cols: _*)
...
//            .drop("temp")
        ...
        hudinewtabke
            ...
            .option(HoodieWriteConfig.TBL_NAME.key,"fact_order_detail")
