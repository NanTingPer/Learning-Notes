...
import org.apache.hadoop.hbase.{CompareOperator, HBaseConfiguration, _}
...
object CleaningJob06{
  ...
  def getScan:Scan = {
    ...
    scan.withStopRow(Bytes.toBytes("0+20241108235959999"))
    scan
  }
  def readHBase(spark:SparkSession):DataFrame={
    ...
    hbaseConf.set(TableInputFormat.INPUT_TABLE,"ods:order_master")
